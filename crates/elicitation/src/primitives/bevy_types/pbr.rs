            ...
            details: PatternDetails::Survey {
                fields: vec![
                    FieldInfo {
                        name: "base_color_r",
                        type_name: "f32",
                        prompt: Some("Base color red (0.0–1.0):"),
                    },
                    FieldInfo {
                        name: "base_color_g",
                        type_name: "f32",
                        prompt: Some("Base color green (0.0–1.0):"),
                    },
                    FieldInfo {
                        name: "base_color_b",
                        type_name: "f32",
                        prompt: Some("Base color blue (0.0–1.0):"),
                    },
                    FieldInfo {
                        name: "base_color_a",
                        type_name: "f32",
                        prompt: Some("Base color alpha (0.0–1.0):"),
                    },
                    FieldInfo {
                        name: "emissive_r",
                        type_name: "f32",
                    ...
                    FieldInfo {
                        ...
                        type_name: "f32",
                        prompt: Some("Emissive exposure weight (0.0–1.0):"),
                    },
                    FieldInfo {
                        name: "perceptual_roughness",
                        type_name: "f32",
                        prompt: Some("Perceptual roughness (0.0–1.0):"),
                    },
                    FieldInfo {
                        name: "metallic",
                        type_name: "f32",
                        prompt: Some("Metallic factor (0.0–1.0):"),
                    },
                    FieldInfo {
                        name: "reflectance",
                        type_name: "f32",
                        prompt: Some("Reflectance (0.0–1.0):"),
                    },
                    FieldInfo {
                        name: "ior",
                        type_name: "f32",
