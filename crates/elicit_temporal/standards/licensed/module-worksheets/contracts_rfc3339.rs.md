...
| `Rfc3339UnknownLocalOffsetUsesNegativeZero` | `unknown local-offset convention` | `RFC 3339 §4.3` | `../../public/rfc3339.txt lines 254-261` | `yes` |
| `Rfc3339LocalOffsetNotUnknown` | `timestamp does not use unknown local-offset convention` | `RFC 3339 §4.3` | `../../public/rfc3339.txt lines 254-261` | `yes` |
...
| `4.3 Unknown Local Offset Convention` | `covered, but revision-sensitive` | `Rfc3339UnknownLocalOffsetUsesNegativeZero`, `Rfc3339LocalOffsetNotUnknown` | Reconcile this pre-update RFC 3339 law with the RFC 9557 update to Section `4.3`. |
...
| `5.6 Internet Date/Time Format` | `covered` | the full `Rfc3339*` grammar family above | The remaining question is whether space-separated serialization belongs in parser and formatter trait seams. |
...
- The main open issue is not acquisition anymore but concordance with the RFC
  9557 update to RFC 3339 Section `4.3`.
...
- [ ] Reconcile the RFC 9557 update to RFC 3339 Section `4.3` with the existing unknown-local-offset contracts.
- [ ] Decide whether the optional space-separated note in Section `5.6` belongs in parser and formatter trait seams.
