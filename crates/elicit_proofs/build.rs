...
const VERUS_INV_NAV: &str = concat!(
    "#[cfg(verus)] verus! { pub open spec fn archive_nav_consistent",
    "(_state: &ArchiveNavState) -> bool { true } }",
);

const VERUS_INV_OVERLAY: &str = concat!(
    "#[cfg(verus)] verus! { pub open spec fn archive_overlay_consistent",
    "(_state: &ArchiveOverlayState) -> bool { true } }",
);

const VERUS_INV_PANEL: &str = concat!(
    "#[cfg(verus)] verus! { pub open spec fn archive_panel_consistent",
    "(_state: &ArchivePanelState) -> bool { true } }",
);
