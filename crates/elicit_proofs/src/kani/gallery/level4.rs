...
impl elicitation::KaniCompose for G4Unit {
    fn kani_depth0() -> Self { G4Unit::A }
    fn kani_depth1() -> Self { G4Unit::B }
    fn kani_depth2() -> Self { G4Unit::C }
    fn kani_any() -> Self {
...
impl elicitation::KaniCompose for G8Unit {
    fn kani_depth0() -> Self { G8Unit::A }
    fn kani_depth1() -> Self { G8Unit::B }
    fn kani_depth2() -> Self { G8Unit::C }
    fn kani_any() -> Self {
        let v: usize = kani::any();
        kani::assume(v < 8);
        match v {
            0 => G8Unit::A, 1 => G8Unit::B, 2 => G8Unit::C, 3 => G8Unit::D,
            4 => G8Unit::E, 5 => G8Unit::F, 6 => G8Unit::G, _ => G8Unit::H,
        }
    }
}
...
impl elicitation::KaniCompose for G16Unit {
    fn kani_depth0() -> Self { G16Unit::V0 }
    fn kani_depth1() -> Self { G16Unit::V1 }
    fn kani_depth2() -> Self { G16Unit::V2 }
    fn kani_any() -> Self {
        let v: usize = kani::any();
        kani::assume(v < 16);
        match v {
            0 => G16Unit::V0, 1 => G16Unit::V1, 2 => G16Unit::V2, 3 => G16Unit::V3,
            4 => G16Unit::V4, 5 => G16Unit::V5, 6 => G16Unit::V6, 7 => G16Unit::V7,
            8 => G16Unit::V8, 9 => G16Unit::V9, 10 => G16Unit::V10, 11 => G16Unit::V11,
            12 => G16Unit::V12, 13 => G16Unit::V13, 14 => G16Unit::V14, _ => G16Unit::V15,
        }
    }
}

#[cfg(kani)] fn unit_consistent(_: &G4Unit) -> bool { true }
#[cfg(kani)] fn unit_consistent8(_: &G8Unit) -> bool { true }
#[cfg(kani)] fn unit_consistent16(_: &G16Unit) -> bool { true }
#[cfg(kani)] fn unit_id4(s: G4Unit) -> G4Unit { s }
#[cfg(kani)] fn unit_id8(s: G8Unit) -> G8Unit { s }
#[cfg(kani)] fn unit_id16(s: G16Unit) -> G16Unit { s }
...
impl elicitation::KaniCompose for G4Prim {
    fn kani_depth0() -> Self { G4Prim::A { val: 0 } }
    fn kani_depth1() -> Self { G4Prim::B { val: 1 } }
    fn kani_depth2() -> Self { G4Prim::C { val: 2 } }
    fn kani_any() -> Self {
        let v: usize = kani::any();
        kani::assume(v < 4);
        match v {
...
#[derive(Clone)]
enum G8Prim {
    V0 { val: u32 }, V1 { val: u32 }, V2 { val: u32 }, V3 { val: u32 },
    V4 { val: u32 }, V5 { val: u32 }, V6 { val: u32 }, V7 { val: u32 },
}

#[cfg(kani)]
impl elicitation::KaniCompose for G8Prim {
    fn kani_depth0() -> Self { G8Prim::V0 { val: 0 } }
    fn kani_depth1() -> Self { G8Prim::V1 { val: 1 } }
    fn kani_depth2() -> Self { G8Prim::V2 { val: 2 } }
    fn kani_any() -> Self {
        let v: usize = kani::any();
        kani::assume(v < 8);
        match v {
...
enum G16Prim {
    V0 { val: u32 }, V1 { val: u32 }, V2 { val: u32 }, V3 { val: u32 },
    V4 { val: u32 }, V5 { val: u32 }, V6 { val: u32 }, V7 { val: u32 },
    V8 { val: u32 }, V9 { val: u32 }, V10 { val: u32 }, V11 { val: u32 },
    V12 { val: u32 }, V13 { val: u32 }, V14 { val: u32 }, V15 { val: u32 },
}

#[cfg(kani)]
impl elicitation::KaniCompose for G16Prim {
    fn kani_depth0() -> Self { G16Prim::V0 { val: 0 } }
    fn kani_depth1() -> Self { G16Prim::V1 { val: 1 } }
    fn kani_depth2() -> Self { G16Prim::V2 { val: 2 } }
    fn kani_any() -> Self {
        let v: usize = kani::any();
        kani::assume(v < 16);
        match v {
...
fn prim_consistent4(s: &G4Prim) -> bool {
    match s { G4Prim::A { val } | G4Prim::B { val } | G4Prim::C { val } | G4Prim::D { val } => *val < 1000 }
}
#[cfg(kani)]
fn prim_consistent8(s: &G8Prim) -> bool {
    match s {
        G8Prim::V0 { val } | G8Prim::V1 { val } | G8Prim::V2 { val } | G8Prim::V3 { val }
        | G8Prim::V4 { val } | G8Prim::V5 { val } | G8Prim::V6 { val } | G8Prim::V7 { val }
        => *val < 1000
    }
}
#[cfg(kani)]
fn prim_consistent16(s: &G16Prim) -> bool {
    match s {
        G16Prim::V0 { val } | G16Prim::V1 { val } | G16Prim::V2 { val } | G16Prim::V3 { val }
        | G16Prim::V4 { val } | G16Prim::V5 { val } | G16Prim::V6 { val } | G16Prim::V7 { val }
        | G16Prim::V8 { val } | G16Prim::V9 { val } | G16Prim::V10 { val } | G16Prim::V11 { val }
        | G16Prim::V12 { val } | G16Prim::V13 { val } | G16Prim::V14 { val } | G16Prim::V15 { val }
        => *val < 1000
    }
}

#[cfg(kani)] fn prim_id4(s: G4Prim) -> G4Prim { s }
#[cfg(kani)] fn prim_id8(s: G8Prim) -> G8Prim { s }
#[cfg(kani)] fn prim_id16(s: G16Prim) -> G16Prim { s }
