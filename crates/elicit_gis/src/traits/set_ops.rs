...
pub trait SfsSetOps: SfsGeometry {
    ...
    fn convex_hull(&self) -> GisResult<Box<dyn SfsGeometry>>;
    ...
    fn union(&self, other: &dyn SfsGeometry) -> GisResult<Box<dyn SfsGeometry>>;
    ...
    fn difference(&self, other: &dyn SfsGeometry) -> GisResult<Box<dyn SfsGeometry>>;
    ...
    fn sym_difference(&self, other: &dyn SfsGeometry) -> GisResult<Box<dyn SfsGeometry>>;
}
