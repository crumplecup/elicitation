...
pub use contracts::{
    ...
    FeatureSemanticsMustNotChange, FeatureTypeEqualsFeature, FeatureValid,
    ...
    FileExtensionIsGeojson, ForeignMembersAtAnyLevelShouldBeIgnored,
    ForeignMembersCannotOverrideTypeMember, ForeignMembersDoNotAlterSemantics,
    FullRfc7946Compliance, GeoJsonBboxMemberIsOptional, GeoJsonBboxWhenPresentIsArray,
    GeoJsonDocumentValid, GeoJsonForeignMembersShouldBeIgnored,
