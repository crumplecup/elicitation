...
#[derive(Prop)]
#[prop(credential = WcagVerified, creusot_invariant_fn = "archive_nav_consistent", kani_invariant_fn = "archive_nav_consistent", verus_invariant_fn = "archive_nav_consistent")]
