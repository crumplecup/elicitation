...
#[derive(Prop)]
#[prop(credential = ConnectionEstablished, creusot_invariant_fn = "archive_connection_consistent", kani_invariant_fn = "archive_connection_consistent", verus_invariant_fn = "archive_connection_consistent", verus_inv_body = "true")]
