...
//! | [`trait_factories`] | Plugin (shadow trait), Component, Resource, … factories |
...
// Hidden re-exports for bridge macros generated by #[reflect_trait(shadow_trait)].
// The generated impl_<trait>! macros emit `$crate::__bevy::...` and
// `$crate::__ref_cast::...` so that downstream crates do not need bevy or
// ref_cast as direct dependencies to call those macros.
#[doc(hidden)]
pub use ::bevy as __bevy;
#[doc(hidden)]
pub use ::ref_cast as __ref_cast;
...
// ── scene re-exports ─────────────────────────────────────────────────────────
pub use scene::{Name, WorldInstanceReady};

// ── app re-exports ───────────────────────────────────────────────────────────
pub use app::{App, AppExit};
pub use plugin_group::{
    DefaultPlugins, PluginGroup, PluginGroupBuilder, prime_bevy__app__plugin_group,
};
pub use trait_factories::{Plugin, prime_bevy__app__plugin};
